...
import android.apn.androidpn.server.xmpp.UnauthenticatedException;
import android.apn.androidpn.server.xmpp.UnauthorizedException;
import android.apn.androidpn.server.xmpp.auth.AuthManager;
import android.apn.androidpn.server.xmpp.auth.AuthToken;
        ...
        try {
            ...
            if (IQ.Type.get == packet.getType()) { // get query
                ...
                if (password != null && AuthManager.isPlainSupported()) {
                	...
                	System.out.println("))))auth name password token((((");
